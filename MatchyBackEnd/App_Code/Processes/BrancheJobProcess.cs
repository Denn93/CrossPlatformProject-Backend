...
namespace Processes
{
    ...
    {
        private readonly List<String> _defaultSelect = new List<string> { "branche_ID", "crawlerID", "companyID", "source_ID", "education_ID", "title", "description", "place_date", "employment" };
